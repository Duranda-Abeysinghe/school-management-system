...
export default function StudentDashboard() {
  ...
  // 🔧 FIX: use the logged-in student's actual ID, not a hardcoded "1"
    ...
    <div>
      ...
      <div className="stats-grid" style={{ marginBottom: '24px' }}>
        {[
          ...
          { label: 'Subjects',      value: marks.length,    icon: '📚', color: '#7c3aed', bg: '#faf5ff' },
      ...
      <div className="grid-2" style={{ marginBottom: '24px' }}>
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          <div className="flex-between" style={{ marginBottom: '16px' }}>
            ...
            <Link to="/student/marks" style={{ fontSize: '0.8rem', color: '#7c3aed', textDecoration: 'none', fontWeight: '600' }}>View All →</Link>
          </div>
          {marks.length === 0 ? (
            <p style={{ color: '#94a3b8', fontSize: '0.88rem' }}>No marks recorded yet.</p>
          ) : (
            marks.slice(0, 5).map((m, i, arr) => (
              <div key={m.id} style={{ marginBottom: i < arr.length - 1 ? '14px' : 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{
                      background: `${getGradeColor(m.grade)}15`, color: getGradeColor(m.grade),
          ...
          <div style={{ background: 'white', borderRadius: '16px', padding: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ background: '#f1f5f9', borderRadius: '10px', height: '8px', overflow: 'hidden', marginBottom: '8px' }}>
      ...
      {requests.length > 0 && (
        <div style={{ background: 'white', borderRadius: '16px', padding: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
          <div className="flex-between" style={{ marginBottom: '14px' }}>
            ...
            <Link to="/student/requests" style={{ fontSize: '0.8rem', color: '#7c3aed', textDecoration: 'none', fontWeight: '600' }}>View All →</Link>
          </div>
